...
router.post("/:publicationId/commentcreate", isUserLoggedIn, async (req, res, next)=>{
    ...
    try {
        ...
        const x = await Publication.findByIdAndUpdate(publicationId, {comment: [addedComment]} )
